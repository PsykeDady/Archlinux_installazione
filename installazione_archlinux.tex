...
\end{lstlisting}
			...
			Pakku è scritto in NIM, un linguaggio di programmazione funzionale molto molto interessante :) se siete del settore vi consiglio di leggerne qualcosa sul web
\nlinea
	\nlinea
